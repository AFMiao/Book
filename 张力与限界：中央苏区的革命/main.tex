...
\usepackage{graphicx}
\graphicspath{{epub/OEBPS/Images/}} % 建议设定统一的图片存放路径
...
\input{chapters/燃烧的革命.tex}
\input{chapters/第五次围剿_南京政府全力以赴.tex}
\input{chapters/第五次反围剿_中共绝境求生.tex}
\input{chapters/消耗战中的资源陷阱.tex}
\input{chapters/内外挤迫下的社会政治困境.tex}
\input{chapters/第五次围剿与反围剿的战争.tex}

\input{chapters/结语_革命的张力.tex}
\input{chapters/附件_作战经过要图.tex}
\input{chapters/后记.tex}
