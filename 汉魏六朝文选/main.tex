\documentclass[a4paper, 12pt, openright]{ctexbook} % 移除了 fontset=fandol，准备自定义字体 
...
\fancyfoot[C]{\thepage} % 
% 将标签挂载到奇数页右侧和偶数页左侧 [cite: 4]
\fancyhead[RO]{\drawthumb{north east}} % [cite: 4]
\fancyhead[LE]{\drawthumb{north west}} % [cite: 4]
...
\title{\Huge \textbf{汉魏六朝文选}}
\author{\textbf{【中】刘文忠}\quad 选编}
\date{}
...
\input{chapters/贾谊.tex}
\input{chapters/晁错.tex}
\input{chapters/枚乘.tex}
