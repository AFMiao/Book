...
% --- 引入图片处理宏包 ---
\usepackage{graphicx}
\graphicspath{{images/}} % 建议设定统一的图片存放路径
...
\captionsetup[figure]{
    ...
    labelfont={bf, sffamily},  % 标签加粗，并使用你配置好的无衬线字体（思源黑体）
...
\title{\Huge \textbf{力量训练基础}}
\author{\textbf{【美】马克·瑞比托}}
\date{}
...
\input{chapters/力量.tex}
\input{chapters/深蹲.tex}
